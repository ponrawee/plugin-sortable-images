var jsPsychCategorizeImageSortable = (function (jspsych) {
  'use strict';
   ...
   *
   */
  class SortableImagesPlugin {
      constructor(jsPsych) {
          this.jsPsych = jsPsych;
      }
      trial(display_element, trial) {
          if (((trial.category_count === null) && (trial.categories === null)) ||
          ...
          const style_html = () => {
              const wrapperElement = document.querySelector('#jspsych-sortable-images');
              const imageListElement = wrapperElement.querySelector('.image-list');
              const imageElements = wrapperElement.querySelectorAll('.image-list .image img');
              const categoryElements = wrapperElement.querySelectorAll('.category');
              const categoryWrapperElement = wrapperElement.querySelector('.category-wrapper');
  ...
  SortableImagesPlugin.info = info;

  return SortableImagesPlugin;
